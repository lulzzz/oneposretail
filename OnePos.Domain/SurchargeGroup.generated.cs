...
namespace OnePos.Domain
{
    ...
    public partial class SurchargeGroup
    {
        public SurchargeGroup()
        {
            this.SurchargeConfigurations = new HashSet<SurchargeConfiguration>();
        }
        ...
        public virtual ICollection<SurchargeConfiguration> SurchargeConfigurations { get; set; }
    }
}
