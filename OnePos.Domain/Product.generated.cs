...
namespace OnePos.Domain
{
    ...
    public partial class Product
    {
        public Product()
        {
            this.InventoryCountLogs = new HashSet<InventoryCountLog>();
            this.VendorProducts = new HashSet<VendorProduct>();
            this.ForcedModifierGroups = new HashSet<ForcedModifierGroup>();
        ...
        public Nullable<bool> IsDisplayOnBilling { get; set; }
        ...
        public virtual ICollection<InventoryCountLog> InventoryCountLogs { get; set; }
        public virtual ICollection<VendorProduct> VendorProducts { get; set; }
        public virtual ICollection<ForcedModifierGroup> ForcedModifierGroups { get; set; }
