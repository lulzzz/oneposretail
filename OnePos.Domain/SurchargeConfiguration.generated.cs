...
namespace OnePos.Domain
{
    ...
    public partial class SurchargeConfiguration
    {
        public SurchargeConfiguration()
        {
            this.SurchargeGroups = new HashSet<SurchargeGroup>();
        }
        ...
        public bool AlwaysRunSurcharge { get; set; }
        ...
        public virtual ICollection<SurchargeGroup> SurchargeGroups { get; set; }
    }
}
